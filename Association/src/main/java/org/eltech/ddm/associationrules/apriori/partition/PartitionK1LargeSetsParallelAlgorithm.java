...
//
//public class PartitionK1LargeSetsParallelAlgorithm extends MiningAlgorithm {
//
//	public PartitionK1LargeSetsParallelAlgorithm(
...
//
//		K_1LargeItemSetsFromCurrentCycleStep k1lisccs = new K_1LargeItemSetsFromCurrentCycleStep(miningSettings,
//				new CreateKItemSetCandidateWithTIDsStep(miningSettings),
//				new RemoveUnsupportItemSetStep(miningSettings));
//
//		ParallelByData pbd = new ParallelByData(miningSettings,k1lisccs);
...
//				new K_1LargeItemSetsCycleStep(miningSettings, pbd));
...
//		EMiningModel resultModel = new PartitionK1LargeSetsParallelModel((AssociationRulesFunctionSettings) miningSettings);
//
//		return resultModel;
//	}
//
