...
////import org.eltech.ddm.association.apriori.steps.BuildNewItemSets;
////import org.eltech.ddm.association.apriori.steps.GenerateItemSets;
...
//
//public class PartitionLargeSetsParallelAlgorithm extends MiningAlgorithm {
//
//	public PartitionLargeSetsParallelAlgorithm(
...
//
//		CreateKItemSetCandidateWithTIDsStep cti = new CreateKItemSetCandidateWithTIDsStep(miningSettings);
//		//cti.addListenerExecute(new StepExecuteTimingListner());
//
//		RemoveUnsupportItemSetStep ruis = new RemoveUnsupportItemSetStep(miningSettings);
//		//ruis.addListenerExecute(new StepExecuteTimingListner());
//
//		K_1LargeItemSetsFromCurrentCycleStep k1l = new K_1LargeItemSetsFromCurrentCycleStep(miningSettings, cti, ruis);
//		k1l.addListenerExecute(new StepExecuteTimingListner());
//
//		K_1LargeItemSetsCycleStep k1 = new K_1LargeItemSetsCycleStep(miningSettings, k1l);
//		k1.addListenerExecute(new StepExecuteTimingListner());
//
//		LargeItemSetListsCycleStep lislcs = new LargeItemSetListsCycleStep(miningSettings, k1);
//		lislcs.addListenerExecute(new StepExecuteTimingListner());
//
//		ParallelByData pbd = new ParallelByData(miningSettings,lislcs);
